...
function Register() {
  ...
  const onRegister = async (e) => {
    ...
    try {
      ...
      console.log("Final FormData before submission:", formDataToSend);
      const result = await addCustomer(formDataToSend);
          ...
          <form onSubmit={onRegister}>
            <div className="row">
              ...
              {[
                ...
                "mobileNo", "password", "confirmPassword", "houseNo",
                "building", "street", "area", "city", "state", "zipcode"
              ].map((field, index) => (
